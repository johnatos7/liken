...
public class ProfileFragment extends SherlockFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		userinfo=mSQLiteHelper.getProfile();
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		iv_person=(ImageView) v.findViewById(R.id.iv_person);
		tv_numberAsked = (TextView) v.findViewById(R.id.tv_numberAsked);
		tv_name=(TextView) v.findViewById(R.id.tv_name);
		tv_numberAnswered = (TextView) v.findViewById(R.id.tv_numberAnswered);
		firstRow = (LinearLayout) v.findViewById(R.id.firstRow);
		secondRow = (LinearLayout) v.findViewById(R.id.secondRow);
		thirdRow = (LinearLayout) v.findViewById(R.id.thirdRow);
		fourthRow = (LinearLayout) v.findViewById(R.id.fourthRow);
		screenWidth = container.getWidth();
		
		tv_name.setText(userinfo.get("username"));
		return v;
	}
	@Override
	public void onStart() {
	  ...
	  EasyTracker tracker = EasyTracker.getInstance(getActivity());
	    tracker.set(Fields.SCREEN_NAME, "Profile Fragment");
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		generateFollowingView();
		/*
		 * $function = $_POST['function']; if($function=="getProfile"){ $UserID
		 * = $_POST['UserID']; getProfile($UserID); }
		 */
		wp_QueryQuestions.add(new BasicNameValuePair("UserID", mSQLiteHelper
				.getUserID()));
		wp_QueryQuestions.add(new BasicNameValuePair("function", "getProfile"));
	...
	private void getProfilePic() {
				setClickListener(userinfo.get("profilepicpath"));
				imageLoader
				.displayImage(
						userinfo.get("profilepicpath"),
						iv_person,
						((GlobalState) getActivity().getApplicationContext()).options_profile_img,
						((GlobalState)getActivity().getApplicationContext()).animateFirstListener);
	...
	private void generateFollowingView() {
		ArrayList<String> listTopics = mSQLiteHelper.getTopics();
